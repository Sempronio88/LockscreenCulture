...
class PalabrasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "Palabras"
        b.txtInfo.text = "Toca una palabra para editarla o borrarla."
    ...
    private fun dialogoEditar(existente: Palabra?) {
        ...
        val eTermino = EditText(this)
        eTermino.hint = "Palabra"
        eTermino.setText(existente?.termino ?: "")
        val eDef = EditText(this)
        eDef.hint = "Definición"
        eDef.setText(existente?.definicion ?: "")

        val spinner = Spinner(this)
        val nombres = cats.map { it.nombre }
        ...
        val builder = AlertDialog.Builder(this)
            ...
            .setPositiveButton("Guardar") { _, _ ->
                ...
                if (t.isNotEmpty()) {
                    if (existente == null) {
                        palabras.add(Palabra(Almacen.nuevoId(), t, dfn, catId))
                    } else {
